...
Autocompletion helps you write code more quickly and with fewer typing mistakes. The more you type, the more the autocompletion menu narrows down, making it easier to find what you’re looking for.
...
In the list, you’ll see names you didn’t define. It's perfectly fine to ignore those names.
