...
## Infinite Loops
 ...
 This is called an _infinite loop_. It's not really infinite, because in most cases it will cause the program to run out of memory and eventually crash (or the bottle will run out of shampoo).
 */
