 ...
 */
let sentense1 = "Baby, baby, baby, oh"
let sentense2 = "Like, Baby, baby, baby, no"
let sentense3 = "I thought you'd always be mine, mine"
let line = "\n"

func babyJustinBieberCorus(){
    print(sentense1 + line + sentense2 + line + sentense2 + line + sentense3 + line)
}

babyJustinBieberCorus()
/*:
