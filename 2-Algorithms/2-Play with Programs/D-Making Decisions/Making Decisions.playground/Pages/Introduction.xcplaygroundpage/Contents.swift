...
## Making Decisions
 ...
 A code segment refers to a collection of program statements that are part of a program. All of the code segments you've written so far have run in playgrounds — and run from the first line to the last, in order. No matter what you give your code to work on, it does the same things with it.
...
page 1 of 15  |  [Next: True and False](@next)
 */