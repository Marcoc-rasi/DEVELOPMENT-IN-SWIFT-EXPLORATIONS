...
## Lists
 ...
 People use lists all the time. You might have a to do list, a wish list, a music playlist, even a bucket list. Lists are very useful and they’re common in coding too.
...
- How can you rearrange the list?
 ...
 In Swift, a list is called an _array_. It's an important *data abstraction*—a way to think about a concept, such as a list, as a unit without having to think about all its individual elements. Arrays, like all data abstractions, help you to simplify your code by providing solutions for all the dilemmas above.
...
page 1 of 18  |  [Next: Array Literals](@next)
 */