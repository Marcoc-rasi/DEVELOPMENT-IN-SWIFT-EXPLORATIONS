...
/*:
 ...
 It would be much better to have a `Song` instead of a `String`, a `String` and an `Int`. The term for this higher-level concept is *data abstraction*.
 
 Next, see how to define a `Song`.
 
page 1 of 10  |  [Next: Custom Types](@next)
 */