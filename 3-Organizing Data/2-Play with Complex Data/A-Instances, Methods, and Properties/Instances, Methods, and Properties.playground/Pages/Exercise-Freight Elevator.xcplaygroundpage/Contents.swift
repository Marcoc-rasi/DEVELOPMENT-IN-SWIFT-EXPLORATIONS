...
var secondPulley = TreehousePulley(weightCapacity: 5000)
/*:
 - callout(Exercise): 
 ...
 */
ricketyRope.addLoadToBasket(loadWeight: itemWeight1 * 3)
ricketyRope.addLoadToBasket(loadWeight: itemWeight2 * 2)
ricketyRope.addLoadToBasket(loadWeight: itemWeight3)
ricketyRope.canHandleAdditionalLoad(itemWeight1 * 3 + itemWeight2 * 2 + itemWeight3)
secondPulley.canHandleAdditionalLoad(itemWeight1 * 3 + itemWeight2 * 2 + itemWeight3)// i don't need a third pulley
/*:
